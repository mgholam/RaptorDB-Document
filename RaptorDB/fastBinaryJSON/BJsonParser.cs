...
namespace fastBinaryJSON
{
    internal class BJsonParser
    {
        ...
        {
            ushort u = (ushort)RaptorDB.Helper.ToInt16(json, index);
            index += 2;
            return u;
        }
        ...
        {
            ulong u = (ulong)RaptorDB.Helper.ToInt64(json, index);
            index += 8;
            return u;
        }
        ...
        {
            uint u = (uint)RaptorDB.Helper.ToInt32(json, index);
            index += 4;
            return u;
        }
        ...
        {
            short u = (short)RaptorDB.Helper.ToInt16(json, index);
            index += 2;
            return u;
        }
        ...
        {
            long u = (long)RaptorDB.Helper.ToInt64(json, index);
            index += 8;
            return u;
        }
        ...
        {
            int u = (int)RaptorDB.Helper.ToInt32(json, index);
            index += 4;
            return u;
        }
        ...
        {
            int c = RaptorDB.Helper.ToInt32(json, index);
            index += 4;
        ...
        {
            int[] i = new int[4];
            i[0] = RaptorDB.Helper.ToInt32(json, index);
            index += 4;
            i[1] = RaptorDB.Helper.ToInt32(json, index);
            index += 4;
            i[2] = RaptorDB.Helper.ToInt32(json, index);
            index += 4;
            i[3] = RaptorDB.Helper.ToInt32(json, index);
            index += 4;
        ...
        {
            long l = RaptorDB.Helper.ToInt64(json, index);
            index += 8;

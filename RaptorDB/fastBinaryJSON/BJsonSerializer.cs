...
namespace fastBinaryJSON
{
    internal class BJSONSerializer
    {
        ...
        private void WriteUShort(ushort p)
        {
            ...
            _output.Write(RaptorDB.Helper.GetBytes(p, false), 0, 2);
        }
        ...
        private void WriteDecimal(decimal p)
        {
            ...
            foreach (var c in b)
                _output.Write(RaptorDB.Helper.GetBytes(c, false), 0, 4);
        }

        private void WriteULong(ulong p)
        {
            _output.WriteByte(TOKENS.ULONG);
            _output.Write(RaptorDB.Helper.GetBytes((long)p, false), 0, 8);
        }

        private void WriteUInt(uint p)
        {
            _output.WriteByte(TOKENS.UINT);
            _output.Write(RaptorDB.Helper.GetBytes(p, false), 0, 4);
        }

        private void WriteLong(long p)
        {
            _output.WriteByte(TOKENS.LONG);
            _output.Write(RaptorDB.Helper.GetBytes(p, false), 0, 8);
        }

        private void WriteChar(char p)
        {
            _output.WriteByte(TOKENS.CHAR);
            _output.Write(RaptorDB.Helper.GetBytes((short)p, false),0, 2);
        ...
        private void WriteBytes(byte[] p)
        {
            ...
            _output.Write(RaptorDB.Helper.GetBytes(p.Length, false), 0, 4);
        ...
        private void WriteInt(int i)
        {
            ...
            _output.Write(RaptorDB.Helper.GetBytes(i, false), 0, 4);
        }
        ...
        private void WriteString(string s)
        {
            ...
            _output.Write(RaptorDB.Helper.GetBytes(b.Length, false), 0, 4);
            _output.Write(b, 0, b.Length);
        }
    }
}
